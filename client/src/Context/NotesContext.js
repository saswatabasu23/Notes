...
const NotesContext = ({ children }) => {
  ...
  const getGroups = useCallback(async () => { 
    try {
      const response = await axios.get('https://notes-xhpq.onrender.com/api/groups');
...
getGroups()
  ...
  const createGroup = async (name,color) => {
    try {
      const response = await axios.post('https://notes-xhpq.onrender.com/api/groups', { name , color });
      getGroups(); 
  ...
  const deleteGroup = async(groupId) =>{
    try {
      await axios.delete(`https://notes-xhpq.onrender.com/api/groups/${groupId}`);
      getGroups(); 
  ...
  const getNotes = useCallback(async (groupId) => {
    if (groupId) {
      try {
        const response = await axios.get(`https://notes-xhpq.onrender.com/api/group?groupId=${groupId}`); 
  ...
  const createNote = async (noteData) => {
    try {
     const response= await axios.post('https://notes-xhpq.onrender.com/api/notes',  noteData ); 
